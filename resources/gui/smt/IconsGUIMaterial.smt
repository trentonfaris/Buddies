...
RenderState:
    ...
    Depth: true
    # View and projection matrices.  Used to override the rendering mode to a static matrix.
...
#   -RGB: color(0,0,0)
#   -RGBA: color(0,0,0,0)
# - Matrix (***NOT IMPLEMENTED***)(Only square matrices supported)
#   - mat2(0,0,0,0)
...
MaterialParams:
    Diffuse: texture://Buddies/resources/gui/icons.png
