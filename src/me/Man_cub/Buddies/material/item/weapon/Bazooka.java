...
import me.Man_cub.Buddies.component.entity.substance.object.projectile.RocketProj;
...
public class Bazooka extends RangedWeapon {
	
	public Bazooka(String name, int id, int max_ammo, WeaponType weaponType) {
		super(name, id, BuddiesMaterialModels.BAZOOKA, max_ammo, weaponType);
