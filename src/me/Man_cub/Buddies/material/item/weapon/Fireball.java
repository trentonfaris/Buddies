...
import me.Man_cub.Buddies.component.entity.substance.object.projectile.FireballProj;
...
public class Fireball extends RangedWeapon {
	
	public Fireball(String name, int id, int max_ammo, WeaponType weaponType) {
		super(name, id, BuddiesMaterialModels.FIREBALL, max_ammo, weaponType);
	...
	public void shoot(Entity entity) {
		if (canUse(entity)) {
			entity.getWorld().createAndSpawnEntity(entity.getPhysics().getPosition(), LoadOption.NO_LOAD, FireballProj.class);
