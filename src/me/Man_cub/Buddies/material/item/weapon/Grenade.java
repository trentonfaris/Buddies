...
import me.Man_cub.Buddies.component.entity.substance.object.projectile.GrenadeProj;
...
public class Grenade extends RangedWeapon {
	...
	public Grenade(String name, int id, int max_ammo, WeaponType weaponType) {
		super(name, id, BuddiesMaterialModels.GRENADE, max_ammo, weaponType);
