...
public class BuddiesCuboidLightBuffer extends AlignedCuboidNibbleLightBuffer {
	...
	protected BuddiesCuboidLightBuffer(Modifiable holder, int id, int baseX, int baseY, int baseZ, int sizeX, int sizeY, int sizeZ) {
		super(holder, id, baseX, baseY, baseZ, sizeX, sizeY, sizeZ);
	}

	protected BuddiesCuboidLightBuffer(Modifiable holder, int id, int baseX, int baseY, int baseZ, int sizeX, int sizeY, int sizeZ, byte[] data) {
